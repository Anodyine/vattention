...
\title{Are Custom Drivers Needed for vAttention?}

\author{\IEEEauthorblockN{Project Team}
\IEEEauthorblockA{CDA 5106 Course Project}}
...
\appendix
\noindent\textbf{TA Verification Guide.}
After finishing the report, teaching assistants can use the repository's
...
located in that repository at \texttt{docs/ta-verification-guide.md}.
